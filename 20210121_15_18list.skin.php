...
<!--             <th scope="col">번호</th>
            ...
            <th scope="col">상태</th> -->
			<th scopt="col">번호</th>
			<th scopt="col">대출종류</th>
			<th scopt="col">고객명</th>
			<th scopt="col">전화번호</th>
			<th scopt="col">희망대출금액</th>
			<th scopt="col">지역</th>
			<th scopt="col">신청날짜</th>
			<th scopt="col">진행상태</th>
			<th scopt="col">최종업데이트</th>
			<th scopt="col">상담사</th>
			<th scopt="col">메모</th>
        ...
        <tr class="<?php echo $lt_class ?>">
            ...
            <?php } ?>
            <td class="td_num"><?php echo $list[$i]['num']; ?></td><!-- 번호를 출력시키는 부분 -->
           <td class="td_loanType">
            ...
            <td class="td_name"><?php echo $list[$i]['name']; ?></td><!-- 고객명 --><!-- 이런식으로 출력을 하면된다 -->
            <td class="td_phoneNumber"><?php echo $list[$i]['phoneNumber']; ?></td><!-- 전화번호 -->
            <!-- <td class="td_stat"><span class=" <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($list[$i]['qa_status'] ? '답변완료' : '답변대기'); ?></span></td> -->
			<td class="td_loanAmount"><?php echo $list[$i]['loanAmount']; ?></td><!-- 희망대출금액 -->
			<td class="td_region"><?php echo $list[$i]['region']; ?></td><!-- 지역 -->
			<td class="td_requestDate"><?php echo $list[$i]['requestDate']; ?></td><!-- 신청날짜 -->
			<td class="td_progress"><?php echo $list[$i]['progress']; ?></td><!-- 진행상태 -->
			<td class="td_lastUpdate"><?php echo $list[$i]['lastUpdate']; ?></td><!-- 최종업데이트 -->
			<td class="td_counselor"><?php echo $list[$i]['counselor']; ?></td><!-- 상담사 -->
			<td class="td_memo"><?php echo $list[$i]['memo']; ?></td><!-- 메모 -->
