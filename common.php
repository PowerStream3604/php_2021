...
$consult_type_option = array("1"=>"아파트 담보 대출","2"=>"주택 담보 대출","3"=>"주택 담보 대출", "4"=>"일반 부동산 담보 대출", "5"=>"전월세 자금 대출", "6"=>"기업프로젝트 대출(PF)", "7"=>"그외 기타 상품");

$consult_region_option = array("1"=>"서울","2"=>"경기도","3"=>"인천관역시","4"=>"부산광역시","5"=>"대구광역시","6"=>"대전광역시","7"=>"광주광역시","8"=>"울산광역시", "9"=>"강원도", "10"=>"경상남도", "11"=>"경상북도", "12"=>"충청남도", "13"=>"충청북도", "14"=>"전라남도", "15"=>"전라북도", "16"=>"제주도");

$consult_progress_state = array("1"=>"접수대기","2"=>"상담진행중","3"=>"상담연결","4"=>"대출심사중","5"=>"승인완료","6"=>"자서대기","7"=>"자서완료","8"=>"기표완료", "9"=>"부재중", "10"=>"부결", "11"=>"대출거부", "12"=>"대출보류", "13"=>"진행포기", "14"=>"마무리가능", "15"=>"관리고객(특판안내)", "16"=>"장기부재","17"=>"타은행진행","18"=>"시기불분명","19"=>"한도부족","20"=>"금리불만","21"=>"진행가능상품무","22"=>"금리불만","23"=>"진행가능상품무","24"=>"중복부결","25"=>"탁감/감정");

$consult_site_option = array("1"=>"뱅크아이","2"=>"아파트777","3"=>"뱅크샵","4"=>"클린모기지","5"=>"해피드림","6"=>"희망드림","7"=>"모기지샵","8"=>"기타");
?>
