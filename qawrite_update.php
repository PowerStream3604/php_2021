...
$phoneNumber = $_REQUEST['qa_addr'];//주소
$phoneNumber = $_REQUEST['qa_loan_amount'];//희망대출금액
$phoneNumber = $_REQUEST['qa_business_manage'];//영업방법
$phoneNumber = $_REQUEST['qa_admin_distin'];//관리자구분
$phoneNumber = $_REQUEST['qa_counselor'];//상담사
$phoneNumber = $_REQUEST['qa_counsel_content'];//상담내용
$phoneNumber = $_REQUEST['qa_receive_type'];// 접수방법
...
$phoneNumber = $_REQUEST['qa_reg_date'];//신청날짜
$phoneNumber = $_REQUEST['qa_url_refer'];//URL 참조
$phoneNumber = $_REQUEST['admin_id'];//어드민 아이디
$phoneNumber = $_REQUEST['master_id'];//마스터아이디
$phoneNumber = $_REQUEST['section_id'];//부서아이디
$phoneNumber = $_REQUEST['qa_loan_type'];//대출종류
$phoneNumber = $_REQUEST['qa_region '];//지역
$phoneNumber = $_REQUEST['qa_file'];//첨부파일 메뉴
$phoneNumber = $_REQUEST['qa_progress'];//진행상태
