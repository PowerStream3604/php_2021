    ...
    <div class="form_01">
        ...
        <ul>
			...
			<li class="">
				...
				<input type="text" name="qa_name" value="" id="qa_name" size="39" required class="frm_input full_input required" maxlength="255" placeholder="이름">
			</li>
	...
	<div class="col-md-4">
        <ul>
			...
			<li class="">
				...
				<input type="text" name="qa_tele_num" value="" id="qa_tele_num" size="39" required class="frm_input full_input required" maxlength="255" placeholder="전화">
			</li>
			...
			<li class="">
				...
				<input type="text" name="qa_reg_date" value="" id="qa_reg_date" size="50"  class="frm_input full_input " maxlength="255" placeholder="YYYY-MM-DD">
			</li>
			<!-- URL참조 -->
			<li class="">
		...
		<ul>
			...
			<li class="">
				...
				<?php foreach($consult_region_option as $key_reg => $data_reg){ ?>
					<option value="<?php echo $key_reg ?>" <?php echo ($key_reg == "1") ? "selected":""?>><?php print_r($data_reg)?></option><!-- 키 부분의 값을 ($key_reg == "1") 을 DB와 연동후 작업이 필요하다 -->
				<?php }?>
				</select>
			</li>
			<!-- 첨부파일 메뉴 -->
			...
			<label for="" class="">접속 URL<strong class="sound_only">필수</strong></label>
				...
				<input type="text" name="qa_access_url" id="qa_access_url" class="frm_input full_input" maxlength="255" placeholder="접속 URL">
...
<!-- 				<select class="frm_input full_input" id="qa_access_url" name="qa_access_url">
			...
			<li class="qa_recei_type_wrap">
				...
				<input type="text" name="qa_no_date" value="" id="qa_no_date" size="50"  class="frm_input full_input " maxlength="255" placeholder="YYYY-MM-DD">
			</li>
		</ul>
	</div>
		</div>
